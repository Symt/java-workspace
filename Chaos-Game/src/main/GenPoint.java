...
public class GenPoint implements Runnable {
	...
	private int givenMax = 1000; // base value, nothing more... this will only be used if the max given by the user is also 1000
	...
	public GenPoint(int sides, int framewidth, int frameheight, int maxPoints) {
		...
		givenMax = maxPoints;
		points = new double[givenMax+1][2];
